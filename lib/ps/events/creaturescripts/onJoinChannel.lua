...
function onJoinChannel(cid, channel, users)
    ...
    if (channel >= CHANNEL_1_POKEMON and channel <= CHANNEL_PACIFIDLOG and
		...
		elseif (channel == CHANNEL_CHIMCHAR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CHIMCHAR))
		elseif (channel == CHANNEL_MONFERNO) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MONFERNO))
		elseif (channel == CHANNEL_INFERNAPE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_INFERNAPE))
			elseif (channel == CHANNEL_PIPLUP) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PLUP))
		elseif (channel == CHANNEL_PRINPLUP) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PRINPLUP))
		elseif (channel == CHANNEL_EMPOLEON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_EMPOLEON))
			elseif (channel == CHANNEL_STARLY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_STARLY))
		elseif (channel == CHANNEL_STARAVIA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_STARAVIA))
		elseif (channel == CHANNEL_STARAPTOR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_STARAPTOR))
			elseif (channel == CHANNEL_BIDOOF) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BIDOOF))
		elseif (channel == CHANNEL_BIBAREL) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BIBAREL))
		elseif (channel == CHANNEL_KRICKETOT) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_KRICKETOT))
		elseif (channel == CHANNEL_KRICKETUNE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_KRICKETUNE))
		elseif (channel == CHANNEL_SHINX) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SHINX))
		elseif (channel == CHANNEL_LUXIO) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LUXIO))
		elseif (channel == CHANNEL_LUXRAY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LUXRAY))
		elseif (channel == CHANNEL_BUDEW) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BUDEW))
		elseif (channel == CHANNEL_ROSERADE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_ROSERADE))
		elseif (channel == CHANNEL_CRANIDOS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CRANIDOS))
		elseif (channel == CHANNEL_RAMPARDOS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_RAMPARDOS))
		elseif (channel == CHANNEL_SHIELDON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SHIELDON))
		elseif (channel == CHANNEL_BASTIODON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BASTIODON))
		elseif (channel == CHANNEL_BURMY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BURMY))
		elseif (channel == CHANNEL_WORMADAM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_WORMADAM))
		elseif (channel == CHANNEL_MOTHIM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MOTHIM))
		elseif (channel == CHANNEL_COMBEE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_COMBEE))
		elseif (channel == CHANNEL_VESPIQUEN) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_VESPIQUEN))
		elseif (channel == CHANNEL_BUIZEL) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BUIZEL))
		elseif (channel == CHANNEL_FLOATZEL) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_FLOATZEL))
		elseif (channel == CHANNEL_CHERUBI) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CHERUBI))
		elseif (channel == CHANNEL_CHERRIM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CHERRIM))
		elseif (channel == CHANNEL_SHELLOS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SHELLOS))
		elseif (channel == CHANNEL_GASTRODON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GASTRODON))
		elseif (channel == CHANNEL_AMBIPOM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_AMBIPOM))
		elseif (channel == CHANNEL_DRIFLOON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DRIFLOON))
		elseif (channel == CHANNEL_DRIFBLIM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DRIFBLIM))
		elseif (channel == CHANNEL_BUNEARY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BUNEARY))
		elseif (channel == CHANNEL_LOPUNNY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LOPUNNY))
		elseif (channel == CHANNEL_MISMAGIUS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MISMAGIUS))
		elseif (channel == CHANNEL_HONCHKROW) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_HONCHKROW))
		elseif (channel == CHANNEL_GLAMEOW) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GLAMEOW))
		elseif (channel == CHANNEL_PURUGLY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PURUGLY))
		elseif (channel == CHANNEL_CHINGLING) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CHINGLING))
		elseif (channel == CHANNEL_STUNKY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_STUNKY))
		elseif (channel == CHANNEL_SKUNTANK) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SKUNTANK))
		elseif (channel == CHANNEL_BRONZOR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BRONZOR))
		elseif (channel == CHANNEL_BRONZONG) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BRONZONG))
		elseif (channel == CHANNEL_BONSLY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_BONSLY))
		elseif (channel == CHANNEL_MIMEJR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MIMEJR))
		elseif (channel == CHANNEL_HAPPINY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_HAPPINY))
		elseif (channel == CHANNEL_CHATOT) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CHATOT))
		elseif (channel == CHANNEL_SPIRITOMB) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SPIRITOMB))
		elseif (channel == CHANNEL_GIBLE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GIBLE))
		elseif (channel == CHANNEL_GABITE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GABITE))
		elseif (channel == CHANNEL_GARCHOMP) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GARCHOMP))
		elseif (channel == CHANNEL_MUNCHLAX) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MUNCHLAX))
		elseif (channel == CHANNEL_RIOLU) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_RIOLU))
		elseif (channel == CHANNEL_LUCARIO) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LUCARIO))
		elseif (channel == CHANNEL_HIPPOPOTAS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_HIPPOPOTAS))
		elseif (channel == CHANNEL_HIPPOWDON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_HIPPOWDON))
		elseif (channel == CHANNEL_SKORUPI) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SKORUPI))
		elseif (channel == CHANNEL_DRAPION) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DRAPION))
		elseif (channel == CHANNEL_CROAGUNK) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CROAGUNK))
		elseif (channel == CHANNEL_TOXICROAK) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_TOXICROAK))
		elseif (channel == CHANNEL_CARNIVINE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CARNIVINE))
		elseif (channel == CHANNEL_FINNEON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_FINNEON))
		elseif (channel == CHANNEL_LIMINEON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LIMINEON))
		elseif (channel == CHANNEL_MANTYKE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MANTYKE))
		elseif (channel == CHANNEL_SNOVER) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SNOVER))
		elseif (channel == CHANNEL_ABOMASNOW) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_ABOMASNOW))
		elseif (channel == CHANNEL_WEAVILE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_WEAVILE))
		elseif (channel == CHANNEL_MAGNEZONE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MAGNEZONE))
		elseif (channel == CHANNEL_RHYPERIOR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_RHYPERIOR))
		elseif (channel == CHANNEL_TANGROWTH) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_TANGROWTH))
		elseif (channel == CHANNEL_ELECTIVIRE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_ELECTIVIRE))
		elseif (channel == CHANNEL_MAGMORTAR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MAGMORTAR))
		elseif (channel == CHANNEL_TOGEKISS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_TOGEKISS))
		elseif (channel == CHANNEL_YANMEGA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_YANMEGA))
		elseif (channel == CHANNEL_LEAFEON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_LEAFEON))
		elseif (channel == CHANNEL_GLACEON) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GLACEON))
		elseif (channel == CHANNEL_GLISCOR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GLISCOR))
		elseif (channel == CHANNEL_MAMOSWINE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MAMOSWINE))
		elseif (channel == CHANNEL_PORYGONZ) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PORYGONZ))
		elseif (channel == CHANNEL_GALLADE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GALLADE))
		elseif (channel == CHANNEL_PROBOPASS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PROBOPASS))
		elseif (channel == CHANNEL_DUSKNOIR) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DUSKNOIR))
		elseif (channel == CHANNEL_FROSLASS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_FROSLASS))
		elseif (channel == CHANNEL_ROTOM) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_ROTOM))
		elseif (channel == CHANNEL_UXIE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_UXIE))
		elseif (channel == CHANNEL_MESPRIT) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MESPRIT))
		elseif (channel == CHANNEL_AZELF) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_AZELF))
		elseif (channel == CHANNEL_DIALGA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DIALGA))
		elseif (channel == CHANNEL_PALKIA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PALKIA))
		elseif (channel == CHANNEL_HEATRAN) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_HEATRAN))
		elseif (channel == CHANNEL_REGIGIGAS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_REGIGIGAS))
		elseif (channel == CHANNEL_GIRATINA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GIRATINA))
		elseif (channel == CHANNEL_CRESSELIA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_CRESSELIA))
		elseif (channel == CHANNEL_PHIONE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_PHIONE))
		elseif (channel == CHANNEL_MANAPHY) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_MANAPHY))
		elseif (channel == CHANNEL_DARKRAI) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_DARKRAI))
		elseif (channel == CHANNEL_SHAYMIN) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_SHAYMIN))
		elseif (channel == CHANNEL_ARCEUS) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_ARCEUS))
